...
- Conduction heat transfer: Occurs when a temperature gradient exists through a solid or a stationary fluid (liquid or gas).
...
$$
where
$h=\text{convection constant } (Units=\frac{W}{m^2K})$
